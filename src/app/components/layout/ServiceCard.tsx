...
export default function Card2({ elementNumber }: ServiceCardProps) {
  ...
  return (
    <div
      className="box-border h-full w-full md:px-8 md:py-16 lg:px-20 lg:py-20 bg-cover bg-center "
      style={{
    ...
    >
      ...
      <div className="h-full flex justify-between gap-4 ">
        ...
        <div className="relative lg:h-[429px] md:w-1/3 lg:w-2/4 flex flex-col gap-4">
          <div className="h-3/5 w-full">
            <div className="swiper-pagination w-full flex flex-col gap-6 h-full">
              {offers.map((offer, index) => (
                ...
                >
                  ...
                  <div className="w-full absolute bottom-40 lg:static lg:w-1/2 text-start box-border lg:pl-4 md:text-sm  font-thin lg:text-xs">
                    {index === selectedOfferIndex && (
          ...
          <div className="h-1/3 box-border lg:pl-4 lg:w-1/2   lg:ml-auto flex flex-col justify-end">
